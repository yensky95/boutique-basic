...
do
    ...
    if [[ $toint -gt 120 && $execmode -eq 0 && $lock -eq 0 ]] || [[ $execmode -eq 0 && $totcpucomp -gt 90000 && $lock -eq 0 ]];
    then
        if [ $toint -gt 180 ]
        then
            lockmodecounter=0
    ...
    elif [[ $toint -gt 120 && $execmode -eq 1 && $lock -eq 0 ]] || [[ $execmode -eq 1 && $totcpucomp -gt 85000 && $lock -eq 0 ]];
     then
        if [ $toint -gt 180 ]   
        then
            lockmodecounter=0
    ...
    elif [[ $toint -gt 120 && !($execmode -eq 3) && $execmode -eq 2 && $lock -eq 0 ]] || [[ $execmode -eq 2 && $totcpucomp -gt 75000 && !($execmode -eq 3) && $lock -eq 0 ]];
    then   
        if [ $toint -gt 180 ]
        then
            lockmodecounter=0
    ...
    if [[ $toint -lt 45 && $execmode -eq 3 && $lock -eq 0 ]] || [[ $execmode -eq 3 && $totcpucomp -lt 32000 && $lock -eq 0 ]];
    then   
        if [ $lockmode -ne 2 ]
        then
            echo "Going into basic high performance mode"
    ...
    elif [[ $toint -lt 55 && $execmode -eq 2 && $lock -eq 0  ]] || [[ $execmode -eq 2 && $totcpucomp -lt 35000 && $lock -eq 0 ]];
    then   
        if [ $lockmode -ne 1 ]
        then
            echo "Going into normal low power mode"
